function clarky = Airfoilimport(filename, startRow, endRow)
%IMPORTFILE3 Import numeric data from a text file as a matrix.
%   CLARKY50000RENCRIT9 = IMPORTFILE3(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   CLARKY50000RENCRIT9 = IMPORTFILE3(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   clarky50000rencrit9 = importfile3('clarky50000rencrit9.txt', 3, 95);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/21 16:09:34
...
clarky = table(dataArray{1:end-1}, 'VariableNames', {'alpha','CL','CD'});
